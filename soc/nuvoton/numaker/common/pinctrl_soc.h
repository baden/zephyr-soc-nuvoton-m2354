...
// #define MFP_CFG(pinmux)       (((pinmux)&0x000000FF) << ((PIN_INDEX(pinmux) % 4) * 8))	// M460
#define MFP_CFG(pinmux)       (((pinmux)&0x000000FF) << ((PIN_INDEX(pinmux) % 8) * 4))	// M2354
// #define NU_MFP_POS(pinindex)  ((pinindex % 4) * 8) // M460
#define NU_MFP_POS(pinindex)  ((pinindex % 8) * 4) // M2354
// #define NU_MFP_MASK(pinindex) (0x1f << NU_MFP_POS(pinindex)) // M460
#define NU_MFP_MASK(pinindex) (0x0f << NU_MFP_POS(pinindex)) // M2354
