...
#define DT_DRV_COMPAT nuvoton_numaker2_pinctrl
...
static void configure_pin(const pinctrl_soc_pin_t *pin)
{
	...
	// uint32_t *GPx_MFPx = ((uint32_t *)MFP_BASE) + port_index * 4 + (pin_index / 4);	// M460
	// For M2354
	uint32_t *GPx_MFPx = ((uint32_t *)MFP_BASE) + port_index * 2 + (pin_index / 8);	// M2354
